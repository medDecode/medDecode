...
function handleMenuButtonClick(clickedBtn, allButtons, panels) {
    const targetPanelId = clickedBtn.getAttribute('data-panel');
...
function openProfileSettings() {
    alert('Openly Profile Settings');
    // Додати потрібну логіку
}

function openPasswordSettings() {
    alert('Openly Password Settings');
    // Додати потрібну логіку
}

function openOtherSettings() {
    alert('Openly Other Settings');
    // Додати потрібну логіку
}
